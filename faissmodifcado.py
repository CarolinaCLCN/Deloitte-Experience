...
class FAISSIndex():
    ...
    def __init__(self, dimension: int = 1536, embeddings=None):
        ...
        # >>> ADDED: metadata list (parallel array to chunks_list)
    ...
    Note:
        ...
        # >>> ADDED: Ensure metadata_list exists
        ...
        for chunk in text_chunks:
            ...
            # >>> ADDED: Normalize chunk so we always have metadata
            ...
            # >>> ADDED: Store metadata in parallel list
    ...
    def retrieve_chunks(self, query: str, num_chunks: int = 5) -> list:
        ...
        # >>> CHANGED: Return metadata instead of only raw text
        return [
            self.metadata_list[i]  # >>> CHANGED
            for i in I[0]
            if i < len(self.metadata_list)  # >>> ADDED safety check
        ]
